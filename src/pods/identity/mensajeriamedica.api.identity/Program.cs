...
public class Program
{
    ...
    public static void Main(string[] args)
    {
        ...
        builder.Services.AddTransient<IServicioAdministracion, ServicioAdministracion>();
        builder.Services.AddTransient<IServicioInterprocesoSesion, ServicioInterprocesoSesion>();
