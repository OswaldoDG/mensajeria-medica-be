...
/// <summary>
/// Menajes de la aplicación para los usuarios de los clientes.
/// </summary>
...
#pragma warning disable CS8618 // Un campo que no acepta valores NULL debe contener un valor distinto de NULL al salir del constructor. Considere la posibilidad de agregar el modificador "required" o declararlo como un valor que acepta valores NULL.
    ...
    /// <summary>
    /// Hash del mensaje para evitar duplicados al enviar el mensaje.
    /// </summary>
    public string Hash { get; set; } // Hascode del contenido del mensaje, indexar, maxlen 128.
    ...
    /// <summary>
    /// Navegación cliente emisor del mensaje.
    /// </summary>
